  ...
  return (
    <div>
      <Menu as='div' className='inline-block text-left'>
        <div className='flex'>
          <Menu.Button className='inline-flex gap-2 w-full rounded-md bg-white md:px-4 py-2 text-sm font-medium text-slate-700 hover:bg-opacity-100 '>
...
const Navbar = () => {
  ...
  return (
    <>
      <div className='relative bg-[#5f9d83] z-50'>
        <nav className='container mx-auto flex items-center justify-between p-5'>
          <div>
            <Link to='/' className='text-[#0e4c31] text-xl font-extrabold'>
              Job<span className='text-[#ffffff]'>Board</span>
            </Link>
          </div>
          ...
          <li>
            ...
            <li>
              <Link to='/' className="text-[white]">Find Job</Link>
            </li>
            <li>
              <Link to='/upload-job' className="text-[white]">Upload Job</Link>
            </li> 
          </ul>
