                ...
                <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all mt-20'>
                  ...
                  <div className='w-full flex items-center justify-center py-4 '>
                    <button
                      className={`flex-1 px-4 py-2 rounded text-sm outline-none ${accountType === "seeker"
                        ? "bg-[#5f9d83] text-white font-semibold"
                        : "bg-white border border-[#5f9d83] text-[#5f9d83]"
                        }`}
                  ...
                  >
                    ...
                    <div className='mt-2 flex mx-auto'>
                      <CustomButton
                        type='submit'
                        containerStyles={`inline-flex justify-center rounded-md bg-[#5f9d83] px-8 py-2 text-sm font-semibold text-white outline-none hover:bg-[#0e4c31]`}
                        title={isRegister ? "Sign Up" : "Login Account"}
                      />
                    </div>
                  </form>
