...
const UploadJob = () => {
  ...
  return (
    ...
    <div className='container mx-auto flex flex-col md:flex-row gap-8 2xl:gap-14 bg-[#f7fdfd] px-5'>
      <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md mx-auto'>
        <div>
          <p className='text-[#5f9d83] font-semibold text-2xl flex justify-center'>Job Post</p>
          ...
          >
            ...
            <div className='mt-2 mx-auto'>
              {isLoading ? (
                ...
                type='submit'
                containerStyles='inline-flex justify-center rounded-md border border-transparent bg-[#5f9d83] px-8 py-2 text-sm font-medium text-white hover:bg-[#0e4c31] hover:text-[white] focus:outline-none'
                title='Post'
              />}
            </div>
          </form>
    ...
    <div className='w-full md:w-1/3 2xl:2/4 p-5 mt-20 md:mt-0'>
        <p className='text-gray-500 font-semibold'>Recent Job Post(s)</p>
